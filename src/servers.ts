...
export const SERVER = {
  ...
  uk1: {
    ...
    dataVersions: [230814, 230920, 231113],
  },
  nl1: {
  ...
  planet: {
    ...
    dataVersions: [
      ...
      230227, 230329, 230503, 230602, 230710, 230814, 230920, 231113,
    ],
  },
  beta: {
...
export async function getServersList(request: Request) {
  ...
  const lastApprovedAndReleasedGoogleAppVersionCode = 230922;
  const lastApprovedAndReleasediOSAppVersionCode = 230922;
