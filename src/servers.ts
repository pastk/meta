...
export const SERVER = {
  ...
  planet: {
    ...
    dataVersions: [
      ...
      230227, 230329, 230503, 230602, 230710, 230814, 230920, 231113, 231213, 240105,
    ],
  },
  beta: {
...
export async function getServersList(request: Request) {
  ...
  const lastApprovedAndReleasedGoogleAppVersionCode = 240109;
  const lastApprovedAndReleasediOSAppVersionCode = 240109;
