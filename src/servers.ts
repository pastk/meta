...
export const SERVER = {
  backblaze: {
    ...
    dataVersions: [
      ...
      220816, 220912, 221029, 221119, 221216, 230121, 230210, 230227, 230329, 230503, 230602,
    ],
  },
  uk1: {
    // Mythic Beasts VPS (London, UK) 200TB/mo.
    url: 'https://cdn-uk1.organicmaps.app/',
    dataVersions: [230329, 230503, 230602],
  },
  nl1: {
...
export async function getServersList(request: Request) {
  ...
  const lastApprovedAndReleasedGoogleAppVersionCode = 230604;
  const lastApprovedAndReleasediOSAppVersionCode = 230508;
