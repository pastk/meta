...
export const SERVER = {
  backblaze: {
    ...
    dataVersions: [
      ...
      231113, 231213, 240105, 240202, 240228, 240326,
    ],
  },
  uk1: {
    // Mythic Beasts VPS (London, UK) 200TB/mo.
    url: 'https://cdn-uk1.organicmaps.app/',
    dataVersions: [240202, 240228, 240326],
  },
  nl1: {
...
export async function getServersList(request: Request) {
  ...
  const lastApprovedAndReleasedGoogleAppVersionCode = 240303;
