...
const SERVER = {
  backblaze: {
    ...
    dataVersions: [210529, 210703, 210729, 210825, 211002, 211022, 211122, 220103, 220204, 220314, 220415, 220515, 220613, 220718, 220816]
  },
  uk1: {
      ...
      if (dataVersion == 0) {
        ...
        case 'OC': // Oceania
          servers = [SERVER.backblaze, SERVER.us2, SERVER.uk1, SERVER.nl1, SERVER.planet]
            .filter(server => server.dataVersions.includes(dataVersion))
          if (servers.length == 0) {
